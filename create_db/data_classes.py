...
class Player(Base):
    ...
    shoots = Column(String(20))
    draft_team_name = Column(String(50))
    experience = Column(Float)
    nba_debut = Column(Integer)
    position_1 = Column(String(20))
    position_2 = Column(String(20))
    position_3 = Column(String(20))
    position_4 = Column(String(20))
    position_5 = Column(String(20))
    position_6 = Column(String(20))
    draft_year = Column(Integer)
    height_cm = Column(Float)
    weight_kg = Column(Float)
    age = Column(Float)
    draft_round_pick_rank = Column(Float)
    draft_overall_pick_rank = Column(Float)
